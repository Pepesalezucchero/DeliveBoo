...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-around pt-4">
                            <div class="col-sm-12 col-xl-4 w-100">
                                <input class="btn btn-save" type="submit" value="Salva">
                            </div>
                        </div>
                    </div>
    ...
    @else()
        <div class="container text-center mt-3">
            ...
            <a class="btn btn-save" href="{{route('restaurant.show', Auth::user()->id === $restaurant->user_id)}}">Torna al tuo ristorante</a>
        </div>
    @endif
